...
#keyword search
    ...
    cur.execute("SELECT AUDIO_FILE_ID, DATE_INTERVIEWED, TITLE, DESCRIPTION FROM (KEYWORD_SEARCH NATURAL JOIN AUDIO_FILE) ORDER BY DATE_INTERVIEWED DESC")
    rows = cur.fetchall()
    return rows
...
#interviewer search
    ...
    cur.execute("SELECT DISTINCT AUDIO_FILE_ID, DATE_INTERVIEWED, TITLE, DESCRIPTION FROM (INTERVIEWER_AUDIO NATURAL JOIN AUDIO_FILE)ORDER BY DATE_INTERVIEWED DESC")
    rows = cur.fetchall()
    return rows
...
#interviewee search
    ...
    cur.execute("SELECT DISTINCT AUDIO_FILE_ID, DATE_INTERVIEWED, TITLE, DESCRIPTION FROM (INTERVIEWEE_AUDIO NATURAL JOIN AUDIO_FILE)ORDER BY DATE_INTERVIEWED DESC")
    rows = cur.fetchall()
    return rows
...
#race search
    ...
    cur.execute("SELECT DISTINCT AUDIO_FILE_ID, DATE_INTERVIEWED, TITLE, DESCRIPTION FROM (INTERVIEWEE_RACE_AUDIO NATURAL JOIN AUDIO_FILE) ORDER BY DATE_INTERVIEWED DESC")
    rows = cur.fetchall()
    return rows
...
#city search
    ...
    cur.execute("SELECT DISTINCT AUDIO_FILE_ID, DATE_INTERVIEWED, TITLE, DESCRIPTION FROM (INTERVIEWEE_CITY_AUDIO NATURAL JOIN AUDIO_FILE) ORDER BY DATE_INTERVIEWED DESC")
    rows = cur.fetchall()
    return rows

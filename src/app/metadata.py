...
def md_query(cur, meta_desc, meta_type):#add md_edit requesr to database
    res = ''
    cur.execute("INSERT INTO REPORT (type, usr_email, a_email, decision) VALUES ('md_edit', 'vbradley@university.com', NULL, NULL)")
...
def edit_md(meta_desc,meta_type):
#Connect to database
    ...
    try:
        ...
        md_query(cur, meta_desc,meta_type)

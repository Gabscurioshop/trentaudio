...
CREATE TABLE USR (USR_EMAIL char(50),USR_USERNAME varchar(40),USR_PASSWORD varchar(100),ROLE varchar(6),PRIMARY KEY(USR_EMAIL));
CREATE TABLE CASUAL_USR(USR_EMAIL char(50),IS_BLOCKED char(1),  /*Y for yes, N for no*/PRIMARY KEY(USR_EMAIL, IS_BLOCKED), FOREIGN KEY (USR_EMAIL) REFERENCES USR(USR_EMAIL));
CREATE TABLE REPORT(REPORT_NUM SERIAL UNIQUE,TYPE varchar(20), /*Audio or Transcript*/USR_EMAIL char(50),A_EMAIL char(50),DECISION char(20), /*Approved, Pending, or Disapproved*/PRIMARY KEY (REPORT_NUM),FOREIGN KEY (USR_EMAIL) REFERENCES USR(USR_EMAIL),FOREIGN KEY(A_EMAIL) REFERENCES USR(USR_EMAIL));
CREATE TABLE TRANSCRIPT (AUDIO_FILE_ID char(50), TRANSCRIBER varchar(40),T_LANGUAGE char(20),FILE bytea, /* transcript as pdf*/PRIMARY KEY (AUDIO_FILE_ID),FOREIGN KEY (AUDIO_FILE_ID) REFERENCES AUDIO_FILE(AUDIO_FILE_ID));
CREATE TABLE BLOCK(USR_EMAIL char(50),A_EMAIL char(50),PRIMARY KEY(USR_EMAIL, A_EMAIL),FOREIGN KEY (USR_EMAIL) REFERENCES USR(USR_EMAIL),FOREIGN KEY(A_EMAIL) REFERENCES USR(USR_EMAIL));

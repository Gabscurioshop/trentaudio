...
CREATE TABLE TRANSCRIPT (AUDIO_FILE_ID char(50), TRANSCRIBER varchar(40),T_LANGUAGE char(20),FILE text, /* transcript as pdf*/PRIMARY KEY (AUDIO_FILE_ID),FOREIGN KEY (AUDIO_FILE_ID) REFERENCES AUDIO_FILE(AUDIO_FILE_ID));
